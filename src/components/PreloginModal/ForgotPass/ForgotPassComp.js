...
export default function ForgotPassComp(props) {
  const { setSignupComp, setLoginComp } = props;
  ...
  return (
    <>
      <div style={{ marginTop: "1.3rem", marginBottom: "1rem", width: "87%" }}>
        <span
          style={{
            marginLeft: "10px",
          }}
