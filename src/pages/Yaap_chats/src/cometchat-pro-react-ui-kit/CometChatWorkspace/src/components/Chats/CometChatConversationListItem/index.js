...
// import "../../../../../../../../../global_styles/yapp-global.css";
import "./style.css";
...
class CometChatConversationListItem extends React.PureComponent {
  ...
  handleMouseHover = (toggleFlag) => {
    if (toggleFlag && !this.state.isHovering) {
      this.setState({ ...this.state, isHovering: true });
    } else if (!toggleFlag && this.state.isHovering) {
      this.setState({ ...this.state, isHovering: false });
    }
  };
  ...
  render() {
    ...
    if (this.state.lastMessage) {
      lastMessageTimeStamp = (
        <span
          ...
          className="item__details__timestamp yapp__timestamp"
        >
    ...
    return (
      <div
        ...
        className={`${
          this.props.isActiveChat
            ? "yapp_chats_list_items list__item active-yapp-chats"
            : "yapp_chats_list_items list__item"
        }`}
        onMouseEnter={() => this.handleMouseHover(true)}
        onMouseLeave={() => this.handleMouseHover(false)}
        id={this.props.index}
        onClick={(e) => {
          this.props.handleClick(this.props.conversation, e.currentTarget.id);
        }}
        ...
        >
          <div css={itemRowStyle()} className="item__details_block_one">
            <div
              ...
              className="yapp_name_user item__details__name"
          ...
          <div css={itemRowStyle()} className="item__details_block_two">
            <div
              ...
              className="yapp_last_msg item__details__last-message"
              onMouseEnter={(event) => this.toggleTooltip(event, true)}
              onMouseLeave={(event) => this.toggleTooltip(event, false)}
            >
