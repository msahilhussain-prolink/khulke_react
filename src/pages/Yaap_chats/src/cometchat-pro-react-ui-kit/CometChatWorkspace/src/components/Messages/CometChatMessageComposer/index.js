...
import {
  ...
  emojiButtonStyle,
  sendButtonStyle,
  sendDisappearButtonStyle,
  reactionBtnStyle,
  stickerBtnStyle,
} from "./style";

// import roundedPlus from "./resources/add-circle-filled.svg";
import roundedPlus from "./resources/gallery.svg";
...
import insertEmoticon from "./resources/smile.svg";
import sendBlue from "./resources/send-message.svg";
import uploadDisappear from "./resources/disappear-message.svg";
...
class CometChatMessageComposer extends React.PureComponent {
  ...
  getCoordinates = (position) => {
    ...
    CometChat.sendCustomMessage(customMessage).then(
      (message) => {
        const newMessageObj = { ...message, _id: message.id };
  ...
  render() {
    ...
    const locationText = Translator.translate(
    ...
    let avp = (
      <React.Fragment>
        ...
        <div
          title={locationText}
          css={fileItemStyle(locationIcon, this.context)}
          className="filelist__item item__video"
          onClick={() => {
            this.sendLocation();
            // this.openFileDialogue("video");
    ...
    let sendBtn = (
      <div
        style={{ width: "2.5rem", marginLeft: "0.4rem" }}
    ...
    const sendDisappearMessageText = Translator.translate(
      "DISAPPEAR_MESSAGE",
      this.context.language
    );
    let sendDisappearBtn = (
      <div
        title={sendDisappearMessageText}
        css={sendDisappearButtonStyle(uploadDisappear, this.context)}
        className="button__send"
        onClick={this.sendDisappearTextMessage}
      >
        <i></i>
      </div>
    );
