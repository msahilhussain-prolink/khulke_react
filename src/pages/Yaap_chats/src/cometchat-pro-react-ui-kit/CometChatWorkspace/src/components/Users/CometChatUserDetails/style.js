...
export const headerCloseStyle = (img, context) => {
	...
	return {
		...
		backgroundColor: `${context.theme.color.customegrey}`,
		width: "24px",
		height: "24px",
		marginRight: "7px",
...
export const handleAudVidStyle = (img, style = {}) => {
	return {
		cursor: 'pointer',
		mask: `url(${img}) center center no-repeat`,
		backgroundColor: `#000`,
...
export const sectionContainerStyle = () => (
	{background: "#F9FAFC", height: '100%', overflow: 'auto'}
)
...
export const followUnfollowProfStyle = () => {
	return {
		color: "red",
		width: "95%",
		borderRadius: '19px',
...
export const disappearSectionStyle = context => {
	return {
		width: "100%",
		"> div": {
			fontWeight: "600",
...
export const contentDisappearItemStyle = () => {
	return {
		"width": "100%",
		"display": "flex",
		"& input": {
...
export const userDisplayPicture = () => {
	return {
		width: "125px",
		height: "125px",
		display: "inline-block",
