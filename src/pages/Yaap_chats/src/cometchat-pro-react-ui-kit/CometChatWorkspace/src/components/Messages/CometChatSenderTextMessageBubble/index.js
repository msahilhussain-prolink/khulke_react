...
import { CometChatMessageActions, CometChatThreadedMessageReplyCount,CometChatThreadedMessageStarred, CometChatReadReceipt, CometChatLinkPreview } from "../";
		...
		return (
			<div css={messageContainerStyle()} className="sender__message__container message__text" onMouseEnter={this.handleMouseHover} onMouseLeave={this.handleMouseHover}>
				...
				<div css={messageInfoWrapperStyle()} className="message__info__wrapper">
					...
					<CometChatThreadedMessageStarred message={this.props.message} actionGenerated={this.props.actionGenerated}  />
