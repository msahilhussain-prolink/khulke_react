...
import AudioIcon from "../../Users/CometChatUserDetails/resources/AudioIcon";
import VideoIcon from "../../Users/CometChatUserDetails/resources/VideoIcon";
  ...
  render() {
    ...
    let audioCallBtn = (
      <div
        ...
        css={chatOptionStyle(() => <></>, this.context, 0)}
        title={audioCallText}
        onClick={this.initiateAudioCall}
      >
        <AudioIcon height={30} width={30}/>
      </div>
    );
    ...
    if (this.context.checkIfCallIsOngoing()) {
      ...
      audioCallBtn = (
        <div
          className={audioCallClassName}
          css={chatOptionStyle(() => <></>, this.context, 1)}
          title={audioCallText}
        >
          <AudioIcon height={30} width={30}/>
        </div>
